...
<?php
    ...
    if( isset($_SESSION['classId']) ) {
    	...
    	foreach ($posts as $post) {
    		...
    		if( isAdmin() ) {
				$delete = "<a href='#'><img src='public_html/img/edit-item.png' width='15px'/></a>";
				$delete = $delete . "<a href='#'><img src='public_html/img/delete-item.png' width='15px'/></a>";
			}
    		...
    		echo "<div class='post_comments'>";
	    		...
	    		foreach ($comments as $comment) {
	    			...
	    			if( isAdmin() ) {
	    				$delete = "<a href='#'><img src='public_html/img/delete-item.png' width='15px'/></a>";
	    			}
